...
# Affine transform: a relation between two images
...
#calculate delanauy triangle: no point in P is inside the circumcircle of any triangle in DT(P)
def calculateDelaunayTriangles(rect, points):
    ...
    for t in triangleList:        
        ...
        if (rectContains(rect, pt1) is not None) and (rectContains(rect, pt2) is not None) and (rectContains(rect, pt3) is not None):
            ind = []
